        ...
        for line in record.invoice_line_ids:
            ...
            if line.product_id.type == 'product':
                ...
                if len(supplier_lines) >= 1:
                    ...
                    log(
                        f"No supplier lines found for product template ID {product_template_id}", level='warning')
                ...
                if len(supplier_lines) == 1 and float_compare(old_price, current_price, precision_digits=2) != 0:
